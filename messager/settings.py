...
SECRET_KEY = 'django-insecure-y3pc(tl^u+4ybn9#1vn0ut!(lh=-bl(0f$tt@_-p&to3_s&xjb'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'messager', 'staticfiles')
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'messager', 'staticfiles')]
